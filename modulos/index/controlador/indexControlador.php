...
final class indexControlador extends Controlador
{
	...
	public function index()
	{
		try {
			...
			$this->_vista->asignar('browser', "Esas usando el navegador <b>{$browser}</b>");
			
			# throw new \Blockpc\Clases\ErrorBlockpc("Error from index"); # Lanzamos un error programado
			# throw new \Exception("Exception ffrom index");
